...
def parse_default():
    ...
    parse.add_argument("--checkpoint", type=str, default="D:\\BaiduNetdiskDownload\\water_dataset\\checkpoint\\3.3-checkpoint-00020-of-00020.pth",  help="model checkpoint to load")
